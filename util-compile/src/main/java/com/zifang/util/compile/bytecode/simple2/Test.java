...
//        String absolutePath = new ClassPathResource("/").getAbsolutePath();
//        File file = new File(absolutePath+"com/jtfu/file/TestClassParse1.class");
...
//        System.err.println(StrUtil.format("常量池大小为:{}",pollSize));
//        //解析常量池
...
//            System.err.println(StrUtil.format("常量池[{}]:{}",index,abstractConstantPool));
//            index++;
//        }
//        //解析访问标志
