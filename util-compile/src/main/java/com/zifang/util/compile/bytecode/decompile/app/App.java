package com.zifang.util.compile.bytecode.decompile.app;

import com.zifang.util.compile.bytecode.decompile.bean.*;
...
import com.zifang.util.compile.bytecode.decompile.core.*;
...
public class App {
    ...
    public App(String classPath, String className) throws IllegalAccessException, InstantiationException {
        this.className = className;
        byte[] data = getClassData(classPath, className);
    ...
    public void doDecomplie() throws Exception {
        ...
        FileCreator.createFile(className, src);
     ...
     *
     * @param len            切分的长度
     * @param method         字段 set 方法的方法名
     * @param flag           是否执行下面的方法
     * @param dataHandler    匿名对象
     * @param parameterTypes set 方法的参数类型
     */
