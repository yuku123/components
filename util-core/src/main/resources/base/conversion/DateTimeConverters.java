...
public class DateTimeConverters implements ConverterLoader {
    ...
    public static class SqlTimeToSqlDate extends AbstractConverter<Time, java.sql.Date> {
        ...
        public java.sql.Date convert(Time obj) throws ConversionException {
    ...
    public static class StringToSqlTime extends GenericLocalizedConverter<String, Time> {
        ...
        public Time convert(String obj, Locale locale, TimeZone timeZone, String formatString) throws ConversionException {
            ...
            try {
                return new Time(df.parse(trimStr).getTime());
            } catch (ParseException e) {
                throw new ConversionException(e);
            }
        }
    ...
    public static class TimestampToSqlTime extends AbstractConverter<Timestamp, Time> {
        ...
        public Time convert(Timestamp obj) throws ConversionException {
