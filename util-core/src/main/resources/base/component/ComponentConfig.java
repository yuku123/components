...
public final class ComponentConfig {
    ...
    public static List<Configuration> getAllConfigurations(String componentName) {
    ...
    private ComponentConfig(String globalName, String rootLocation) throws ComponentException {
        ...
        try {
            ...
            if (!configurations.isEmpty()) {
                this.configurations = Collections.unmodifiableList(new ArrayList<Configuration>(configurations));
            } else {
