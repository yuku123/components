 ...
 */
package com.zifang.util.core.praser.example.simpletest;

import com.zifang.util.core.praser.example.pojo.Bar;
import com.zifang.util.core.praser.example.pojo.Foo;
