...
public final class Chains {
     ...
     */
    public static <K, V, C extends Map<K, V>, CH extends Chain<K, V, C>> org.apache.commons.chain2.ToExecutorCommandSetter<K, V, C> on(CH chain) {
        return new DefaultCommandSetter<K, V, C>(checkNotNullArgument(chain, "Null Chain can not be executed"));
    }

    /**
     * Defines the target {@link org.apache.commons.chain2.Catalog} has to be invoked.
     *
     * @param <K> Context key type
     * @param <V> Context value type
     * @param <C> Type of the context associated with this command
     * @param <CA> Type of the {@link org.apache.commons.chain2.Catalog} to execute
